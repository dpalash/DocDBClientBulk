...
namespace DocDBClientBulk
{
    ...
    {
        const string AuthKey = "HUeDMy8MveOI5k4MYKPj6lzguYC840jftX0cAmWq0TWMjNlK9ix0CkErFDzYBVfsYBeN0oCjWMLyHenjh13wGQ==";
        const string Endpoint = "https://sfneptune.documents.azure.com:443/";

        //const string DbName = "dbnautiskcustomers";
        const string DbName = "dbencukho";
        //const string CollectionName = "enccell";
        const string CollectionName = "encproduct";
        //const string CollectionName = "customercollection";
        ...
        private static async Task InvokeBulkImportSproc()
        {
            ...
            try
            {
                await client.ExecuteStoredProcedureAsync<int>(sprocUri, docs);
            }
